...
public class Email
{
    ...
    public void SaveToDatabase(string connectionString)
    {
        using (var conn = new NpgsqlConnection(connectionString))
        {
            ...
            {
                cmd.Connection = conn;
                cmd.CommandText = "INSERT INTO emails (sender_address, receiver_address, subject, date_sent, email_content, file_path) " +
                                  "VALUES (@sender_address, @receiver_address, @subject, @date_sent, @email_content, @file_path) RETURNING email_id";
